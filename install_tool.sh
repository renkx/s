...
# https://github.com/leitbogioro/Tools/blob/master/README.md
...
# https://blog.cloudflare.com/optimizing-tcp-for-high-throughput-and-low-latency/#cloudflare-production-network-results
